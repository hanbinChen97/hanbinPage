  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a{" "}
        <strong className="text-stone-100">Computer Science Graduate</strong>{" "}
        and <strong className="text-stone-100">LLM Researcher</strong>,
        passionate about exploring the intersection of data science, process
        mining, and AI technologies.
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        Master's student at{" "}
        <strong className="text-stone-100">RWTH Aachen</strong> with research
        focus on
        <strong className="text-stone-100"> Large Language Models</strong> for
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Specialized in Large Language Models and Medical Knowledge Extraction.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>Strong foundation in Software Engineering and Computer Science.</p>
    ),
  },
];
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Master thesis project focusing on leveraging Large Language Models
        (LLMs) for biomedical knowledge extraction. Developed an end-to-end
        pipeline for Named Entity Recognition (NER), Entity Normalization (NEN),
  ...
  },
  {
    ...
    content: (
      <p>
        Developed the frontend using TypeScript, ensuring a robust and scalable
        codebase. Designed interactive chat components using React, enhancing
        user interaction. Integrated internationalization (i18n) to support
  ...
  },
  {
    ...
    content: (
      <p>
        Analyzed climate data with Python/Pandas and visualized results using
        Matplotlib/Seaborn. Utilized Git for version control and Docker for
...
export const socialLinks: Social[] = [
  ...
  {label: "GitLab", Icon: GitLabIcon, href: "https://gitlab.com/hanbin.9797"},
  {
    label: "LinkedIn",
    Icon: LinkedInIcon,
    href: "https://www.linkedin.com/in/hanbin-chen/",
  },
  {
    label: "Hugging Face",
    Icon: HuggingfaceIcon,
    href: "https://huggingface.co/hanbinChen",
  },
];
